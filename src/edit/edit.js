...
const Edit = (props) => {
    ...
    <React.Fragment>
        ...
        <Typography className={classes.body}>
            RitualHub and its accompanying Dataset is all open-source, this means that it is all completely free and accessible to anyone. Being hosted on GitHub anyone can ‘fork’ a copy of the project, make a change to their local version and commit the change to a ‘Pull Request’ (PR), the PR is then reviewed, and if approved is merged into the ‘master’ project.
        </Typography>
        <Typography className={classes.heading}>
            <h1>How to</h1>
            <hr/>
        ...
        <Typography className={classes.body}>
            Below are some useful tools I use in my workflow, all of which are free:
            <ol>
                ...
                <li class={classes.listItem}><b><a href="https://www.jstor.org/">JSTOR</a></b> - JSTOR is a hugely popular digital library, most of the content is however behind paywalls or organisational credentials, but a good place to start searching.</li>
                ...
                <li class={classes.listItem}><b><a>Sci-Hub</a></b> - One of the most important websites you can know about as an amateur scholar, sci-hub provides most paywall blocked articles for free, do a quick Google for it as it's address has to change often.</li>
                ...
                <li class={classes.listItem}><b><a href="http://libgen.li/">LibGen</a></b> - LibGen is another academic file sharing site, but tends to not have Archaeology or Humanaties works so I don't use nearly as often as Sci-Hub or Z-Library.</li>
